...
SurfCollideStyle(hdcll,SurfCollidehdCLL)

#else

#ifndef SPARTA_SURF_COLLIDE_HDCLL_H
#define SPARTA_SURF_COLLIDE_HDCLL_H
...
class SurfCollidehdCLL : public SurfCollide {
 public:
  SurfCollidehdCLL(class SPARTA *, int, char **);
  ~SurfCollidehdCLL();
  void init();
 ...
 private:
  ...
  double acc_ad,acc_n,acc_t,acc_rot,acc_vib;   // surface accomodation coeffs
  ...
  void hdcll(Particle::OnePart *, double *);
};
